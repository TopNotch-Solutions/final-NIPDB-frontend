...
function Reporting() {
  ...
  useEffect(() => {
    const fetchMsmeAllMSME = async () => {
      try {
        ...
        const response = await fetch("https://uat-api.erongored.com.na/msme/admin/all/approved", {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    const fetchMsmeAllMSMEPending = async () => {
      try {
        dispatch(toggleIsSubmittingTrue());
        const response = await fetch("https://uat-api.erongored.com.na/msme/admin/all/pending", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `${serverToken}`,
  ...
  useEffect(() => {
    const fetchMsmeAllMSMERejected = async () => {
      try {
        dispatch(toggleIsSubmittingTrue());
        const response = await fetch("https://uat-api.erongored.com.na/msme/admin/all/rejected", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `${serverToken}`,
  ...
  useEffect(() => {
    const fetchMsmeAllMSMEBlocked = async () => {
      try {
        dispatch(toggleIsSubmittingTrue());
        const response = await fetch("https://uat-api.erongored.com.na/msme/admin/all/blocked", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `${serverToken}`,
  ...
  useEffect(() => {
    const fetchMsmeAllBSO = async () => {
      try {
        dispatch(toggleIsSubmittingTrue());
        const response = await fetch("https://uat-api.erongored.com.na/bso/admin/all/download", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `${serverToken}`,
  ...
  useEffect(() => {
    const fetchMsmeAllUsers = async () => {
      try {
        dispatch(toggleIsSubmittingTrue());
        const response = await fetch("https://uat-api.erongored.com.na/system/all/admin/list/download", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: `${serverToken}`,
