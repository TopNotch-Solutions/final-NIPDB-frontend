...
function Notifications() {
  ...
  useEffect(() => {
    const fetchAllAdminNotifications = async () => {
      try {
        ...
        const response = await fetch(
          `https://uat-api.erongored.com.na/notifications/admin/single/notifications`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  useEffect(() => {
    const fetchAllUnread = async () => {
      try {
        ...
        setIsSubmitting(true);
        const response = await fetch(
          `https://uat-api.erongored.com.na/notifications/admin/all/unread-notification`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  useEffect(() => {
    const fetchAllSent = async () => {
      try {
        ...
        setIsSubmitting(true);
        const response = await fetch(
          `https://uat-api.erongored.com.na/notifications/admin/all/sent-by-admin`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  useEffect(() => {
    const fetchAllRead = async () => {
      try {
        ...
        setIsSubmitting(true);
        const response = await fetch(
          `https://uat-api.erongored.com.na/notifications/admin/all/read-notification`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleStep5 = async () => {
    if (validateFields()) {
      try {
        ...
        const response = await fetch(
          `https://uat-api.erongored.com.na/notifications/admin/create`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleView = async (id) => {
    try {
      ...
      setIsSubmitting(true);
      const response = await fetch(
        `https://uat-api.erongored.com.na/notifications/admin/single/${id}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleViewSent = async (id) => {
    try {
      ...
      setIsSubmitting(true);
      const response = await fetch(
        `https://uat-api.erongored.com.na/notifications/admin/single/sent-by-admin/${id}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          dispatch(toggleIsSubmittingTrue());
          const response = await fetch(
            `https://uat-api.erongored.com.na/notifications/admin/delete/${id}`,
            {
              method: "DELETE",
              headers: {
                "Content-Type": "application/json",
  ...
  const handleNoticationDeletion = async (id) => {
    try {
      ...
      dispatch(toggleIsSubmittingTrue());
      const response = await fetch(
        `https://uat-api.erongored.com.na/notifications/admin/delete/${updatedId}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
