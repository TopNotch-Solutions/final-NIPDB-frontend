...
function Reporting() {
  ...
  const columns1 = [
    ...
    {
      field: "foundersGender",
      headerName: "Founders Gender",
      width: isSmallScreen ? 120 : 180,
    },
    {
      field: "foundersAge",
      headerName: "Founders Age",
      width: isSmallScreen ? 120 : 180,
    },
    {
    ...
    {
      field: "monday",
      headerName: "Monday Hours",
      width: isSmallScreen ? 120 : 180,
    },
    {
      field: "tuesday",
      headerName: "Tuesday Hours",
      width: isSmallScreen ? 120 : 180,
    },
    {
      field: "wednesday",
      headerName: "Wednesday Hours",
      width: isSmallScreen ? 120 : 180,
    },
    {
      field: "thursday",
      headerName: "Thursday Hours",
      width: isSmallScreen ? 120 : 180,
    },
    {
      field: "friday",
      headerName: "Friday Hours",
      width: isSmallScreen ? 120 : 180,
    },
    {
      field: "saturday",
  ...
  return (
    <div className="container-fluid mt-4">
      ...
      <p>
        Access and view detailed reports about Micro, Small, and Medium
        Enterprises (MSMEs) and Business Support Organizations (BSOs).
      </p>
            ...
            >
              <div className="col-12 p-4 shadow rounded-3 mb-4">
                ...
                {activeTab === 1 && (
                  <>
                    <div className="col-12 mt-1">
                      <p className="list-groupp text-center">
                        All Approved MSMEs Report
                      </p>
                      <div className="w-100 d-flex justify-content-between">
                        <BackButton onClick={() => setActiveTab(0)} />
                        {allMSMEList.length > 0 ? (
                          <>
                      ...
                      <Box
                        sx={{ height: 500, width: "100%", marginTop: "10px" }}
                      >
                        <DataGrid
                          rows={rowsAll}
                          columns={columns1}
                ...
                {activeTab === 2 && (
                  <>
                    <div className="col-12 mt-1">
                      <p className="list-groupp text-center">
                        All Pending MSMEs Report
                      </p>
                      <div className="w-100 d-flex justify-content-between">
                        <BackButton onClick={() => setActiveTab(0)} />
                        {allMSMEPendingList.length > 0 ? (
                          <>
                            <DownloadButton
                              onClick={handleDownloadAllMSMEPending}
                            />
                          </>
                        ) : null}
                      </div>
                ...
                {activeTab === 3 && (
                  <>
                    <div className="col-12 mt-1">
                      <p className="list-groupp text-center">
                        All Rejected MSMEs Report
                      </p>
                      <div className="w-100 d-flex justify-content-between">
                        <BackButton onClick={() => setActiveTab(0)} />
                        {allMSMERejectedList.length > 0 ? (
                          <DownloadButton
                            onClick={handleDownloadAllMSMERejected}
                          />
                        ) : null}
                      </div>
                ...
                {activeTab === 4 && (
                  <>
                    <div className="col-12 mt-1">
                      <p className="list-groupp text-center">
                        All Blocked MSMEs Report
                      </p>
                      <div className="w-100 d-flex justify-content-between">
                        <BackButton onClick={() => setActiveTab(0)} />
                        {allMSMEBlockedList.length > 0 ? (
                          <>
                            <DownloadButton
                              onClick={handleDownloadAllBlocked}
                            />
                          </>
                        ) : null}
                      </div>
